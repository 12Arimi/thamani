...
const initialFormData: JointFormData = {
  accountType: 'joint',
  serialNumber: '',
  firstApplicant: {
    fullNames: '',
...
export default function JointAccountPage() {
  ...
  const [formData, setFormData] = useState<JointFormData>(initialFormData)

  // Auto-save to localStorage
  useEffect(() => {
    const timer = setTimeout(() => {
      localStorage.setItem('thamaniSaccoJointDraft', JSON.stringify(formData))
    }, 2000)
  ...
  useEffect(() => {
    const draft = localStorage.getItem('thamaniSaccoJointDraft')
    if (draft) {
      try {
  ...
  const updateFormData = useCallback((updates: Partial<JointFormData>) => {
    setFormData(prev => ({ ...prev, ...updates }))
  }, [])

  const updateApplicant = useCallback((applicantKey: 'firstApplicant' | 'secondApplicant' | 'thirdApplicant', updates: Partial<Applicant>) => {
    setFormData(prev => ({
      ...prev,
      [applicantKey]: { ...prev[applicantKey], ...updates }
    }))
  }, [])
  ...
  const handleSubmit = useCallback(() => {
    ...
    alert('Joint Account application submitted successfully! Check console for data.')
  }, [formData])
  ...
  const renderStep = () => {
    switch (currentStep) {
      ...
      case 2: return renderFirstApplicant()
      case 3: return renderSecondApplicant()
      case 4: return renderAdditionalQuestions()
  ...
  const renderFirstApplicant = () => (
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        <CardTitle>1.2.1 FIRST APPLICANT</CardTitle>
      </CardHeader>
      <CardContent className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <Input 
              value={formData.firstApplicant.fullNames}
              onChange={(e) => updateApplicant('firstApplicant', { fullNames: e.target.value })}
            />
          </div>
          <div>
            ...
            <Input 
              ...
              onChange={(e) => updateApplicant('firstApplicant', { idNumber: e.target.value })}
            />
          </div>
          <div>
            ...
            <Input 
              ...
              onChange={(e) => updateApplicant('firstApplicant', { passportNumber: e.target.value })}
            />
          </div>
          <div>
            ...
            <Input 
              ...
              onChange={(e) => updateApplicant('firstApplicant', { nationality: e.target.value })}
            />
          </div>
          <div>
            ...
            <Input 
              ...
              onChange={(e) => updateApplicant('firstApplicant', { pinNumber: e.target.value })}
            />
          </div>
          <div>
            ...
            <Input 
              ...
              onChange={(e) => updateApplicant('firstApplicant', { dateOfBirth: e.target.value })}
            />
          </div>
          <div>
            ...
            <Input 
              ...
              onChange={(e) => updateApplicant('firstApplicant', { district: e.target.value })}
            />
          </div>
          <div>
            ...
            <Input 
              ...
              onChange={(e) => updateApplicant('firstApplicant', { location: e.target.value })}
            />
          </div>
          <div>
            ...
            <Input 
              ...
              onChange={(e) => updateApplicant('firstApplicant', { subLocation: e.target.value })}
            />
          </div>
          <div>
            <Label>Current Residence County</Label>
            <Input 
              value={formData.firstApplicant.currentResidenceCounty}
              onChange={(e) => updateApplicant('firstApplicant', { currentResidenceCounty: e.target.value })}
            />
          </div>
          <div>
            <Label>Division</Label>
            <Input 
              value={formData.firstApplicant.division}
              onChange={(e) => updateApplicant('firstApplicant', { division: e.target.value })}
            />
          </div>
          <div>
            <Label>Village / Township</Label>
            <Input 
              value={formData.firstApplicant.villageTownship}
              onChange={(e) => updateApplicant('firstApplicant', { villageTownship: e.target.value })}
            />
          </div>
          <div>
            <Label>Address</Label>
            <Input 
              value={formData.firstApplicant.address}
              onChange={(e) => updateApplicant('firstApplicant', { address: e.target.value })}
            />
          </div>
          <div>
            <Label>Postal Code</Label>
            <Input 
              value={formData.firstApplicant.postalCode}
              onChange={(e) => updateApplicant('firstApplicant', { postalCode: e.target.value })}
            />
          </div>
          <div>
            <Label>Office Telephone</Label>
            <Input 
              value={formData.firstApplicant.officeTelephone}
              onChange={(e) => updateApplicant('firstApplicant', { officeTelephone: e.target.value })}
            />
          </div>
          <div>
            <Label>Mobile Number</Label>
            <Input 
              value={formData.firstApplicant.mobileNumber}
              onChange={(e) => updateApplicant('firstApplicant', { mobileNumber: e.target.value })}
            />
          </div>
          <div>
            <Label>Email</Label>
            <Input 
              type="email"
              value={formData.firstApplicant.email}
              onChange={(e) => updateApplicant('firstApplicant', { email: e.target.value })}
            />
          </div>
          <div>
            <Label>Occupation</Label>
            <Input 
              value={formData.firstApplicant.occupation}
              onChange={(e) => updateApplicant('firstApplicant', { occupation: e.target.value })}
            />
          </div>
          <div>
            <Label>Employer</Label>
            <Input 
              value={formData.firstApplicant.employer}
              onChange={(e) => updateApplicant('firstApplicant', { employer: e.target.value })}
            />
          </div>
          <div>
            ...
            <Input 
              type="email"
              value={formData.firstApplicant.employerEmail}
              onChange={(e) => updateApplicant('firstApplicant', { employerEmail: e.target.value })}
            />
          </div>
          <div>
            <Label>Location of Employment</Label>
            <Input 
              value={formData.firstApplicant.locationOfEmployment}
              onChange={(e) => updateApplicant('firstApplicant', { locationOfEmployment: e.target.value })}
            />
          </div>
          <div>
            <Label>Employer's Postal Address</Label>
            <Input 
              value={formData.firstApplicant.employerPostalAddress}
              onChange={(e) => updateApplicant('firstApplicant', { employerPostalAddress: e.target.value })}
            />
          </div>
          <div>
            <Label>Next of Kin / Nominee</Label>
            <Input 
              value={formData.firstApplicant.nextOfKinNominee}
              onChange={(e) => updateApplicant('firstApplicant', { nextOfKinNominee: e.target.value })}
            />
          </div>
          <div>
            <Label>Relationship</Label>
            <Input 
              value={formData.firstApplicant.relationship}
              onChange={(e) => updateApplicant('firstApplicant', { relationship: e.target.value })}
            />
          </div>
          <div>
            <Label>Next of Kin ID Number</Label>
            <Input 
              value={formData.firstApplicant.nextOfKinIdNumber}
              onChange={(e) => updateApplicant('firstApplicant', { nextOfKinIdNumber: e.target.value })}
            />
          </div>
          <div>
            <Label>Next of Kin Address</Label>
            <Input 
              value={formData.firstApplicant.nextOfKinAddress}
              onChange={(e) => updateApplicant('firstApplicant', { nextOfKinAddress: e.target.value })}
            />
          </div>
          <div>
            <Label>Next of Kin Telephone</Label>
            <Input 
              value={formData.firstApplicant.nextOfKinTelephone}
              onChange={(e) => updateApplicant('firstApplicant', { nextOfKinTelephone: e.target.value })}
            />
          </div>
        </div>
      </CardContent>
  ...
  const renderSecondApplicant = () => (
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        <CardTitle>1.2.2 SECOND APPLICANT</CardTitle>
      </CardHeader>
      <CardContent className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <Label>Full Names</Label>
            <Input 
              value={formData.secondApplicant.fullNames}
              onChange={(e) => updateApplicant('secondApplicant', { fullNames: e.target.value })}
            />
          </div>
          <div>
            <Label>ID Number</Label>
            <Input 
              ...
              onChange={(e) => updateApplicant('secondApplicant', { idNumber: e.target.value })}
            />
          </div>
          <div>
            <Label>Passport Number</Label>
            <Input 
              ...
              onChange={(e) => updateApplicant('secondApplicant', { passportNumber: e.target.value })}
            />
          </div>
          <div>
            <Label>Nationality</Label>
            <Input 
              ...
              onChange={(e) => updateApplicant('secondApplicant', { nationality: e.target.value })}
            />
          </div>
          <div>
            <Label>PIN Number</Label>
            <Input 
              ...
              onChange={(e) => updateApplicant('secondApplicant', { pinNumber: e.target.value })}
            />
          </div>
          <div>
            <Label>Date of Birth</Label>
            <Input 
              ...
              onChange={(e) => updateApplicant('secondApplicant', { dateOfBirth: e.target.value })}
            />
          </div>
          <div>
            <Label>District</Label>
            <Input 
              ...
              onChange={(e) => updateApplicant('secondApplicant', { district: e.target.value })}
            />
          </div>
          <div>
            <Label>Location</Label>
            <Input 
              ...
              onChange={(e) => updateApplicant('secondApplicant', { location: e.target.value })}
            />
          </div>
          <div>
            <Label>Sub Location</Label>
            <Input 
              ...
              onChange={(e) => updateApplicant('secondApplicant', { subLocation: e.target.value })}
            />
          </div>
          <div>
            <Label>Current Residence County</Label>
            <Input 
              value={formData.secondApplicant.currentResidenceCounty}
              onChange={(e) => updateApplicant('secondApplicant', { currentResidenceCounty: e.target.value })}
            />
          </div>
          <div>
            <Label>Division</Label>
            <Input 
              value={formData.secondApplicant.division}
              onChange={(e) => updateApplicant('secondApplicant', { division: e.target.value })}
            />
          </div>
          <div>
            <Label>Village / Township</Label>
            <Input 
              value={formData.secondApplicant.villageTownship}
              onChange={(e) => updateApplicant('secondApplicant', { villageTownship: e.target.value })}
            />
          </div>
          <div>
            <Label>Address</Label>
            <Input 
              value={formData.secondApplicant.address}
              onChange={(e) => updateApplicant('secondApplicant', { address: e.target.value })}
            />
          </div>
          <div>
            <Label>Postal Code</Label>
            <Input 
              value={formData.secondApplicant.postalCode}
              onChange={(e) => updateApplicant('secondApplicant', { postalCode: e.target.value })}
            />
          </div>
          <div>
            <Label>Office Telephone</Label>
            <Input 
              value={formData.secondApplicant.officeTelephone}
              onChange={(e) => updateApplicant('secondApplicant', { officeTelephone: e.target.value })}
            />
          </div>
          <div>
            <Label>Mobile Number</Label>
            <Input 
              value={formData.secondApplicant.mobileNumber}
              onChange={(e) => updateApplicant('secondApplicant', { mobileNumber: e.target.value })}
            />
          </div>
          <div>
            <Label>Email</Label>
            <Input 
              type="email"
              value={formData.secondApplicant.email}
              onChange={(e) => updateApplicant('secondApplicant', { email: e.target.value })}
            />
          </div>
          <div>
            <Label>Occupation</Label>
            <Input 
              value={formData.secondApplicant.occupation}
              onChange={(e) => updateApplicant('secondApplicant', { occupation: e.target.value })}
            />
          </div>
          <div>
            <Label>Employer</Label>
            <Input 
              value={formData.secondApplicant.employer}
              onChange={(e) => updateApplicant('secondApplicant', { employer: e.target.value })}
            />
          </div>
          <div>
            <Label>Employer Email</Label>
            <Input 
              type="email"
              value={formData.secondApplicant.employerEmail}
              onChange={(e) => updateApplicant('secondApplicant', { employerEmail: e.target.value })}
            />
          </div>
          <div>
            <Label>Location of Employment</Label>
            <Input 
              value={formData.secondApplicant.locationOfEmployment}
              onChange={(e) => updateApplicant('secondApplicant', { locationOfEmployment: e.target.value })}
            />
          </div>
          <div>
            <Label>Employer's Postal Address</Label>
            <Input 
              value={formData.secondApplicant.employerPostalAddress}
              onChange={(e) => updateApplicant('secondApplicant', { employerPostalAddress: e.target.value })}
            />
          </div>
          <div>
            <Label>Next of Kin / Nominee</Label>
            <Input 
              value={formData.secondApplicant.nextOfKinNominee}
              onChange={(e) => updateApplicant('secondApplicant', { nextOfKinNominee: e.target.value })}
            />
          </div>
          <div>
            <Label>Relationship</Label>
            <Input 
              value={formData.secondApplicant.relationship}
              onChange={(e) => updateApplicant('secondApplicant', { relationship: e.target.value })}
            />
          </div>
          <div>
            <Label>Next of Kin ID Number</Label>
            <Input 
              value={formData.secondApplicant.nextOfKinIdNumber}
              onChange={(e) => updateApplicant('secondApplicant', { nextOfKinIdNumber: e.target.value })}
            />
          </div>
          <div>
            <Label>Next of Kin Address</Label>
            <Input 
              value={formData.secondApplicant.nextOfKinAddress}
              onChange={(e) => updateApplicant('secondApplicant', { nextOfKinAddress: e.target.value })}
            />
          </div>
          <div>
            <Label>Next of Kin Telephone</Label>
            <Input 
              value={formData.secondApplicant.nextOfKinTelephone}
              onChange={(e) => updateApplicant('secondApplicant', { nextOfKinTelephone: e.target.value })}
            />
          </div>
        </div>
      </CardContent>
    ...
    <div className="space-y-6">
      <Card className="w-full max-w-4xl mx-auto">
        ...
        <CardContent className="space-y-4">
          ...
          {formData.showThirdApplicant && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label>Full Names</Label>
                <Input 
                  value={formData.thirdApplicant.fullNames}
                  onChange={(e) => updateApplicant('thirdApplicant', { fullNames: e.target.value })}
                />
              </div>
              <div>
                <Label>ID Number</Label>
                <Input 
                  value={formData.thirdApplicant.idNumber}
                  onChange={(e) => updateApplicant('thirdApplicant', { idNumber: e.target.value })}
                />
              </div>
              <div>
                <Label>Passport Number</Label>
                <Input 
                  value={formData.thirdApplicant.passportNumber}
                  onChange={(e) => updateApplicant('thirdApplicant', { passportNumber: e.target.value })}
                />
              </div>
              <div>
                <Label>Nationality</Label>
                <Input 
                  value={formData.thirdApplicant.nationality}
                  onChange={(e) => updateApplicant('thirdApplicant', { nationality: e.target.value })}
                />
              </div>
              <div>
                <Label>PIN Number</Label>
                <Input 
                  value={formData.thirdApplicant.pinNumber}
                  onChange={(e) => updateApplicant('thirdApplicant', { pinNumber: e.target.value })}
                />
              </div>
              <div>
                <Label>Date of Birth</Label>
                <Input 
                  type="date"
                  value={formData.thirdApplicant.dateOfBirth}
                  onChange={(e) => updateApplicant('thirdApplicant', { dateOfBirth: e.target.value })}
                />
              </div>
              <div>
                <Label>Mobile Number</Label>
                <Input 
                  value={formData.thirdApplicant.mobileNumber}
                  onChange={(e) => updateApplicant('thirdApplicant', { mobileNumber: e.target.value })}
                />
              </div>
              <div>
                <Label>Email</Label>
                <Input 
                  type="email"
                  value={formData.thirdApplicant.email}
                  onChange={(e) => updateApplicant('thirdApplicant', { email: e.target.value })}
                />
              </div>
            </div>
          )}
  ...
  const renderDocuments = () => (
    <Card className="w-full max-w-4xl mx-auto">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <div>
            <Label>Copy of National ID / Passport (All Applicants)</Label>
            <Input 
              type="file"
          ...
          <div>
            <Label>Copy of PIN Certificate (All Applicants)</Label>
            <Input 
              type="file"
          ...
          <div>
            <Label>Passport size photo (All Applicants)</Label>
            <Input 
              type="file"
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="mb-8">
          ...
          <div className="text-center mb-8">
            <p className="text-[#ffde21] font-bold text-xs uppercase tracking-[0.4em] mb-4">Joint Account</p>
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Complete your joint account application with Thamani Sacco
            </p>

...
export default function IndividualApplyPage() {
  ...
  const handleProceed = () => {
    if (agreedToTerms && agreedToRegulatory) {
      router.replace('/membership/individual');
    }
  };
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-lg">
              Please review and agree to the following terms before proceeding with your Individual Membership application
            </p>
          </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 mb-3">
                    I agree to comply with all regulatory requirements and provide accurate information
                  </p>
                  <a
                    href="/regulatory"
                    target="_blank"
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-blue-800 text-sm">
                  By proceeding, you confirm that all information provided will be accurate and you understand that false statements may result in application rejection or legal consequences.
                </p>
              </div>
            </div>
          </div>
